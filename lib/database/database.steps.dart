...
final class Schema3 extends i0.VersionedSchema {
  ...
  late final Shape4 counterparties = Shape4(
    source: i0.VersionedTable(
      entityName: 'counterparties',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: [],
      columns: [_column_0, _column_6, _column_7, _column_13],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
class Shape4 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get description =>
      columnsByName['description']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get defaultCategoryId =>
      columnsByName['default_category_id']! as i1.GeneratedColumn<int>;
}
...
class Shape5 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get counterpartyId =>
      columnsByName['counterparty_id']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get associatedTransactionId =>
      columnsByName['associated_transaction_id']! as i1.GeneratedColumn<int>;
}
