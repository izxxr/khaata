...
class TransactionRepository {
  ...
  Future<int> createTransaction(int accountId, String title, int amount, {String? description}) async {
  ...
  Future<void> updateTransaction(int id, {String? title, int? amount, String? description}) async {
