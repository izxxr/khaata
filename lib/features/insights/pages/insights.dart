      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: AppSpacing.md),
            TransactionsSummaryList(
              stream: context.read<CounterpartyRepository>().watchTopCounterparties([]),
              nameBuilder: (c) => Row(
                children: [
                  Icon(
                    Icons.people,
